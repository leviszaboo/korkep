...
VALUES
  ('Telex', 'telex', 'https://telex.hu', 'https://telex.hu/rss', 'left', 'https://telex.hu/favicon-32x32.png'),
  ('444.hu', '444', 'https://444.hu', 'https://444.hu/feed', 'left', 'https://cdn.444r.cloud/assets/appicon-180.f28fd1db6b2192fcd860.png'),
  ('HVG', 'hvg', 'https://hvg.hu', 'https://hvg.hu/rss', 'left', 'https://cdn.hvg.hu/assets/hvghu/favicon/favicon-96x96.png'),
  ...
  ('ATV', 'atv', 'https://www.atv.hu', 'https://www.atv.hu/feed/', 'center-left', 'https://www.atv.hu/wp-content/uploads/2024/11/favicon-1.ico'),
  ...
  ('Világgazdaság', 'vg', 'https://www.vg.hu', 'https://www.vg.hu/publicapi/hu/rss/vilaggazdasag/articles', 'right', 'https://www.vg.hu/favicon-32x32.png'),
